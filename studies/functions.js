...
// 1. The Two phases of creating functions.
...
// 5. Functions can Optionally take input, and optionally
...
// 6. Scope within a function. Global/Parent-scope vs. Local Scope. 
...
//   however the inverse does not apply.
    ...
    // Outerscope variable was able to be logged since it was defined and 
    // intialized outside of the function.
    
    console.log("The outerScope Variable = " + outerScopeVariable); 
    
    // In contrast the Innerscope cannot be logged from outside the function.
    //Attempting to log the innerScope variable will create an error. 
    
  //  console.log("The innerScope Variable = " + innerScopeVariable); 

// 7. Closures within a function. 
//   Closures are defined as the ability for an inner function to have 
//   access to the scope within the outer function. 
...
console.log("This is the first sum using, two parameters: " + combineOne);
